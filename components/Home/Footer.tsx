    ...
    <div className="pt-20 pb-12">
      ...
      <div className="w-4/5 border-b-[1.2px] pb-8 border-b-slate-500 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12" >
        ...
        <div>
          ...
          <p className="text-sm text-black opacity-60 "> Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur optio modi veritatis odio alias fugiat fugit quae dolore quia obcaecati minus, maxime dignissimos veniam ut.</p>
